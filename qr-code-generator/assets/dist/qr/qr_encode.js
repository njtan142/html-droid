import { alphanumeric_lookup_table, cc_bits_table } from "./qr_table.js";
import { NUMERIC, ALPHANUMERIC, BYTE, KANJI, ECI } from "./types.js";
import { split_into_groups } from "../utils/util.js";
...
*/
export function encode(data, data_type, version, data_bits_length) {
    let bit_stream;
    switch (data_type) {
        case NUMERIC:
...
function encode_alphanumeric(data) {
...
function encode_byte(data) {
    const data_as_binary = data.split('')
        .map(char => char.charCodeAt(0).toString(2).padStart(8, '0'))
        .join('');
    return data_as_binary;
}
function pad_bit_stream(input_stream, bits_to_prepend, data_bits_length) {
...
*/
export function cc_bits(version_num, data_mode) {
...
*/
export function get_prepend_bits(data_len, data_type, version) {
...
/*
    ...
    * @returns The encoding mode of the data.
*/
export function get_encoding_mode(data) {
