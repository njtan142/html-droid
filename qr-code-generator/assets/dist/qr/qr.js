import { encode, get_encoding_mode } from "./qr_encode.js";
import { ERROR_CORRECTION_COL, GROUP_1_BLOCKS, GROUP_1_DATA, GROUP_2_BLOCKS, GROUP_2_DATA, TOTAL_CODEWORDS_COL, qr_table } from "./qr_table.js";
import { rs_encode_message } from "../reed/rs.js";
import { int_array_to_bit_string } from "../utils/util.js";
/**
 ...
 */
export function get_qr_context(data, error_correction_level) {
...
*/
export function get_version_info(data_len, data_type, error_correction) {
 ...
 */
export function generate_data_codewords(context) {
 ...
 */
export function evaluate_matrix(grid) {
 ...
 */
export function evaluate_rule_one(grid) {
    const calculate_penalty = (line) => {
        let count = 1;
 ...
 * @param matrix QR code matrix
 */
export function evaluate_rule_two(grid) {
    let penalty = 0;
 ...
 * @param matrix
 */
export function evaluate_rule_three(grid) {
 ...
 * @param matrix QR code matrix
 */
export function evaluate_rule_four(grid) {
