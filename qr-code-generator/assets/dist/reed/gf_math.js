...
export function gf_sub(a, b) {
    return a ^ b;
}
export function gf_mul(a, b) {
    if (a === 0 || b === 0) {
        return 0;
    }
...
export function gf_poly_scale(p, x) {
...
export function gf_poly_add(p, q) {
...
export function gf_poly_mul(p, q) {
...
export function gf_poly_eval(p, x) {
    let y = p[0];
